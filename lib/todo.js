...
/**
 * List todos by default if no args was provided
 */
...
function list(options){
	...
	// Sort collection by 'completed' property
	filteredItems = _.sortBy(filteredItems, function(item){ return item.completed });
